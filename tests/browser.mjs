...
await page.goto(base+'/options.html');await page.getByRole('button',{name:'保存并测试连接'}).click();await page.getByText('连接成功：你好，这是连接测试。').waitFor();await mkdir('artifacts',{recursive:true});await page.screenshot({path:'artifacts/settings.png',fullPage:true});
