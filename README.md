...
以下为示例文本与预置译文在插件中的显示效果，实际翻译结果取决于所选模型。

**网页双语阅读**：原文与译文相邻，保留正文样式和链接。

![网页双语阅读示例：原文下方显示中文译文，右侧提供悬浮按钮](docs/images/web-reading.png)

**PDF 对照阅读**：左侧保留原始页面，右侧显示对应译文。

![PDF 对照阅读示例：左侧英文原文，右侧中文译文](docs/images/pdf-reading.png)
